...
class config(object):
    def __init__(self) -> None:
        ...
        self.batch_size=64
        self.num_epochs=320
        self.model_path=os.path.join(os.getcwd(), "data", "AttackAssist.TiBERT")
        self.tokenizer=BertTokenizer.from_pretrained(self.model_path)
        self.lr_rate=2e-5
        self.pad_size=128
        self.hidden_size=768
        self.slide_size=5  
        self.save_result=os.path.join(os.getcwd(), "data", "AttackAssist.TibetSegEYE", "segbase.cpkt")
        self.w2i,self.i2w=tools.Tibet_convert_dict(os.path.join(os.getcwd(), "data", "AttackAssist.TibetSegEYE", "vocab.txt"))
        self.b2i,self.i2b=tools.Tibet_convert_dict(os.path.join(os.getcwd(), "data", "AttackAssist.TibetSegEYE", "biotype.txt"))
        self.supvoc=os.path.join(os.getcwd(), "data", "AttackAssist.TibetSegEYE", "rec_dict_rset2.txt")
