...
def visualizer(idx, x_orig, y_orig, x_adv, y_adv, info, stream_writer, tokenizer, key_len=25, val_len=10):
    ...
    if x_adv is None:
        ...
        # modification begin
        with open(os.path.join(os.getcwd(), "logs", "log.txt"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "Tibetan-BERT+TU_SA.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "Tibetan-BERT+TNCC-title.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "Tibetan-BERT+TNCC-document.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-small-v2+TU_SA.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-small-v2+TNCC-title.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-small-v2+TNCC-document.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-base-v2+TU_SA.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-base-v2+TNCC-title.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-base-v2+TNCC-document.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-large-v2+TU_SA.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-large-v2+TNCC-title.log"), "a") as log:
        # with open(os.path.join(os.getcwd(), "logs", "CINO-large-v2+TNCC-document.log"), "a") as log:
